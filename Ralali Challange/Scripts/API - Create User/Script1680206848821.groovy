...
response1 = WS.sendRequest(findTestObject('API OBJECT/Create User', [('url') : GlobalVariable.url, ('access_token') : GlobalVariable.access_token
            , ('name') : GlobalVariable.name, ('gender') : GlobalVariable.gender, ('email') : GlobalVariable.email, ('status') : GlobalVariable.status]))
