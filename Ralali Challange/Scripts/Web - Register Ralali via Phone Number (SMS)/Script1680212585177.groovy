...
String phoneNumber = CustomKeywords.'ralaliKeywords.RandomPhoneNumber.getPhoneNumber'()
...
WebUI.setText(findTestObject('WEB OBJECT/register page/txt_email_phoneNumber'), GlobalVariable.phoneNumber)
...
WebUI.click(findTestObject('WEB OBJECT/register page/otp_viaSMS'))
